"""
Django settings for FAIX Chatbot application.
"""
import os
...
DATABASES = {
    ...
    #     'NAME': os.environ.get('DB_NAME', 'faix_chatbot'),
...
FIREBASE_CONFIG = {
    'enabled': os.environ.get('FIREBASE_ENABLED', 'False').lower() == 'true',
